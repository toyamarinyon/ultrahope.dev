		...
		<main className="min-h-screen px-6 py-8 sm:px-8 lg:px-12">
			<div className="mx-auto flex max-w-7xl flex-col gap-10">
				<header className="flex flex-col gap-4 border-b border-highlight-med pb-6">
					<p className="text-[0.76rem] uppercase tracking-[0.24em] text-muted">
						Theme tokens
					</p>
					<div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
						<div>
							<h1 className="font-serif text-5xl leading-none tracking-[-0.05em] text-rose">
				...
				<section className="grid gap-4 lg:grid-cols-3">
					<div className="rounded-xl border border-highlight-med bg-surface p-5 shadow-editorial lg:col-span-2">
						<p className="text-[0.74rem] uppercase tracking-[0.2em] text-muted">
							Color palette
						</p>
					...
					<div className="rounded-xl border border-highlight-med bg-overlay p-5">
						...
						<div className="mt-5 space-y-5">
							...
							<div className="rounded-lg border border-highlight-med bg-base/70 p-4">
								...
								<p className="mt-3 font-serif text-[2rem] leading-tight tracking-[-0.04em] text-rose">
									Calm, warm, editorial.
								</p>
							</div>
							<div className="rounded-lg border border-highlight-med bg-base/70 p-4">
				...
				<section className="grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
					...
					<div className="rounded-xl border border-highlight-med bg-overlay p-5">
						...
						<div className="mt-5 space-y-4">
							...
							<div className="rounded-xl border border-highlight-med bg-surface p-5 shadow-editorial">
								<p className="font-mono text-sm text-text">shadow-editorial</p>
