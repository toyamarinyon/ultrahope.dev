...
export type BlockDocument = (Writing | WritingItem | _AgentStart | writingItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Writing | writingItem_AsList) & { __isUnion?: true }
...
export interface WritingItem {
    ...
    _sys: BlockDocumentSys
    _title: Scalars['String']
    __typename: 'WritingItem'
}

export type WritingItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC'
...
export interface _components {
    writingItem: writingItem_AsList
    __typename: '_components'
}

export interface writingItem_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
...
export interface BlockDocumentGenqlSelection{
    ...
    on_Writing?: WritingGenqlSelection
    on_WritingItem?: WritingItemGenqlSelection
    on__AgentStart?: _AgentStartGenqlSelection
    on_writingItem_AsList?: writingItem_AsListGenqlSelection
    __typename?: boolean | number
...
export interface QueryGenqlSelection{
    ...
    writing?: (WritingGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (WritingItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (WritingItemOrderByEnum | null), 
    /** Search configuration */
    search?: (WritingItemSearchInput | null), 
...
export interface WritingGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: WritingItemGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: WritingItemGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "Writing"
}

export interface WritingItemGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "WritingItem"
}

export interface WritingItemFilterInput {AND?: (WritingItemFilterInput | null),OR?: (WritingItemFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null)}

export interface WritingItemSearchInput {
...
export interface _componentsGenqlSelection{
    writingItem?: (writingItem_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (WritingItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
...
export interface writingItem_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    items?: WritingItemGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "writingItem_AsList"
}
...
export interface FragmentsMap {
  ...
  Writing: {
    root: Writing,
    selection: WritingGenqlSelection,
}
  WritingItem: {
    root: WritingItem,
    selection: WritingItemGenqlSelection,
}
  _AgentStart: {
    root: _AgentStart,
  ...
  writingItem_AsList: {
    root: writingItem_AsList,
    selection: writingItem_AsListGenqlSelection,
}
}
